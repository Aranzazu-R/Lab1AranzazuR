...
#%% Data (WEIGHTS) de NAFTRAC 31/01/2022
file_data = pd.read_csv("files/NAFTRAC_20200131.csv", skiprows =2)

# Pesos iniciales
weights1 = file_data.iloc[:-1,0:4:3] # Data Frame con los tickers que se van a usar
weights_in2 = file_data.iloc[:-1,0:4:3] # Data Frame con todos los tickers
...
dates = [i[8:12] + "-" + i[12:14] + "-" + i[14:16] for i in files]
